        ...
        >
          <span style={{
            ...
            <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
              <path fill="#4285F4" d="M21.805 10.023H12v3.955h5.39c-.233 1.25-.94 2.313-2.003 3.023v2.5h3.24c1.898-1.75 2.998-4.328 2.998-7.39 0-.665-.06-1.31-.18-1.93z"/>
              <path fill="#34A853" d="M12 22c2.7 0 4.97-.89 6.63-2.41l-3.24-2.5c-.9.61-2.05.96-3.39.96-2.61 0-4.82-1.76-5.61-4.12H3.03v2.59A9.98 9.98 0 0 0 12 22z"/>
              <path fill="#FBBC05" d="M6.39 13.93A5.98 5.98 0 0 1 6.39 10.07V7.48H3.03A9.98 9.98 0 0 0 2 12c0 1.61.39 3.13 1.03 4.52l3.36-2.59z"/>
              <path fill="#EA4335" d="M12 6.04c1.47 0 2.79.51 3.83 1.5l2.87-2.87C16.97 3.18 14.7 2 12 2A9.98 9.98 0 0 0 3.03 7.48l3.36 2.59C7.18 7.8 9.39 6.04 12 6.04z"/>
            </svg>
          </span>
          Ingresar con Google
        </button>
